...
namespace phpsamurai\RepositoryPatternGenerator\Tests;
...
class RepositoryCreatorTest extends TestCase
{
     ...
     */
    private $_config = [
        'base_application_namespace' => 'phpsamurai\RepositoryPatternGenerator\Tests',
    ...
    {
        $app['config']->set('repository_pattern_generator', $config);
    }
